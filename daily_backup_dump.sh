...
#!/bin/sh
 mysqldump -h localhost  --single-transaction -u dumper  --password='password' Gps_Device devices_last_location | gzip >  /home/GPSHourlyDumps/gps_device_locations.sql.gz
